...
| High memory usage, slow responses, or worker crashes | [Performance & RAM](/troubleshooting/performance) |
| Login loops, config drift, or database locks in multi-replica setups | [Scaling & HA Troubleshooting](/troubleshooting/multi-replica) |
...
| Migrating between SQLite and PostgreSQL | [Database Migration](/troubleshooting/manual-database-migration) |
