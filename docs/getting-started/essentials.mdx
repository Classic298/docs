...
- [**Web Search**](/features/chat-conversations/web-search/agentic-search) — connect a search provider (Google, Brave, DuckDuckGo, SearXNG and many more) so the model can look things up
