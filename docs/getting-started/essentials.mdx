...
Tools show up in the `+` menu in the chat input. Enable the ones you want for a given chat; the model only sees the tools you've enabled. There are thousands more on the community site — browse by category and install whatever matches how you actually use Open WebUI.
