...
- Options:
  ...
  - `4` - Tika 4.x
- Default: `3`
- Description: Tells Open WebUI which Apache Tika API to speak, since the two major versions differ in the endpoints they expose. Set this to match the server you are running, or extraction fails against an otherwise healthy Tika. It can also be changed from the Documents tab in the admin settings.
- Persistence: This environment variable is a `ConfigVar` variable.
